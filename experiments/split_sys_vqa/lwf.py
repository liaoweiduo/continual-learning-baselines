...
def lwf_ssysvqa(override_args=None):
    """
...
if __name__ == '__main__':
    ...
    res = lwf_ssysvqa(vars(args))

    '''
    export PYTHONPATH=${PYTHONPATH}:/liaoweiduo/continual-learning-baselines
    EXPERIMENTS: 
    python experiments/split_sys_vqa/naive.py --use_wandb --model resnet --exp_name Resnet-LwF --cuda 1
    '''

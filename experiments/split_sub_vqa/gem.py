...
def gem_ssubvqa_ci(override_args=None):
    """
    GEM algorithm on split substitutivity VQA on class-IL setting.
    """
...
if __name__ == '__main__':
    ...
    res = gem_ssubvqa_ci(vars(args))


    '''
    export PYTHONPATH=${PYTHONPATH}:/liaoweiduo/continual-learning-baselines
    EXPERIMENTS: 
    python experiments/split_sub_vqa/gem.py --use_wandb --exp_name GEM --cuda 0
    python experiments/split_sub_vqa/gem.py --use_wandb --non_comp --exp_name nc-GEM --cuda 3
    '''

...
CUDA_VISIBLE_DEVICES=0 python3 experiments/continual_training.py --exp_name our_test --use_wandb --strategy our --model_backbone vit --train_num_exp 1 --use_interactive_logger --epochs 300 --ssc 0.1 --scc 0.1 --learning_rate 0.001 --skip_fewshot_testing --eval_every 10 --eval_patience 50

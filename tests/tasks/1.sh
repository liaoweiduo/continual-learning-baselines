...
CUDA_VISIBLE_DEVICES=7 python3 experiments/visualize_image_with_similarity_mask.py --exp_name MNt1_lr_reg2-our-tsk-lr0_005-reg1 --use_wandb --strategy our --use_interactive_logger

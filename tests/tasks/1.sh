...
#CUDA_VISIBLE_DEVICES=0 python3 experiments/split_cifar100/continual_training.py --project_name 'SCIFAR100' --dataset 'scifar100' --image_size 32 --n_experiences 20 --use_wandb --model_backbone resnet18 --learning_rate 0.001 --epochs 200

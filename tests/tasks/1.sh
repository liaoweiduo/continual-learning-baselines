...
CUDA_VISIBLE_DEVICES=0 python3 experiments/continual_training.py --exp_name our --use_wandb --strategy our --train_num_exp 1 --use_interactive_logger --epochs 200
